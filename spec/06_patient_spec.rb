...
describe 'Patient' do
  ...
  describe '#new_appointment' do
    it 'given a doctor and date, creates a new appointment belonging to that patient' do
      ...
      #changed order of args for consistants
  ...
  describe '#appointments' do
    it 'has many appointments' do
      ...
      appointment_one = steve.new_appointment( 'Friday, January 32nd', doctor_dog)
      appointment_two = steve.new_appointment( 'Saturday, January 32nd', doctor_howser)
      #changed order of args for the TWO above lines
